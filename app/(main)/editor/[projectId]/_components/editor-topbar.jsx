...
const EditorTopbar = ({ project }) => {
  ...
  const handleResetToOriginal = async () => {
    ...
    try {
      ...
      // Use the SAME logic as canvas initialization
      const imgAspectRatio = fabricImage.width / fabricImage.height;
      const canvasAspectRatio = project.width / project.height;
      let scaleX, scaleY;

      if (imgAspectRatio > canvasAspectRatio) {
        // FabricImg is wider than canvas, scale based on width
        scaleX = project.width / fabricImage.width;
        scaleY = scaleX;
      } else {
        // FabricImg is taller than canvas, scale based on height
        scaleY = project.height / fabricImage.height;
        scaleX = scaleY;
      }

      // Use the SAME positioning logic as initialization
      fabricImage.set({
      ...
      // Add to canvas (no centerObject call, just like initialization)
